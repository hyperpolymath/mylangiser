...
// Replace mylangiser, Mylangiser — See README.adoc for details., just run, Mylangiser started successfully. with actuals
= mylangiser — Quick Start for Users
:toc:
:toclevels: 2

== What is mylangiser?

Mylangiser — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./mylangiser-portable
----
...
[source]
----
Mylangiser started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/mylangiser/wiki
